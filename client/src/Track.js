            ...
            <div className="container mt-4">
                <div className="card mb-4">
                    ...
                    <div className="card-body">
                        ...
                        <p><b>Current stage:</b> {MedStage[ID] && MedStage[ID].replace(/Food Product|med|MED|Med/g, 'Product')}</p>
                    </div>
                </div>
        ...
        return (
            <div className="container mt-4">
                <article className="col-4">
                    ...
                    <br />
                    <span><b>Current stage: </b>{MedStage[ID] && MedStage[ID].replace(/Food Product|med|MED|Med/g, 'Product')}</span>
                    <hr />
                    <br />
                    <h5>Food Product Not Yet Processed...</h5>
                    <button onClick={() => {
                    ...
                    <tbody>
                        {Object.keys(MED).map((key) => (
                            <tr key={key}>
                                ...
                                <td>{MedStage[key] && MedStage[key].replace(/Food Product|med|MED|Med/g, 'Product')}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
